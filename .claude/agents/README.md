...
| **code-quality-reviewer** | Readability, Rust style | Sonnet | `.scratch/reviews/code-quality.md` |
| **test-reviewer** | Test pyramid, coverage | Sonnet | `.scratch/reviews/test-coverage.md` |
| **security-reviewer** | Memory safety, OWASP, vulnerabilities | Sonnet | `.scratch/reviews/security.md` |
...
| `code-quality-review` | Rust code quality checklist | code-quality-reviewer |
| `test-review` | Test quality checklist, Rust testing conventions | test-reviewer |
