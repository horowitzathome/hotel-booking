...
|---|---|---|
| code-quality-reviewer | `.scratch/reviews/code-quality.md` | Readability, idiomatic Rust style |
...
| `src/**/*.rs` | feature-implementer |
| `tests/**/*.rs` | feature-implementer |
| Config files, templates | feature-implementer |
...
| PRD boundary violations (Rust code, struct references, internal code names) | Critical | `[BLOCKED]` |
