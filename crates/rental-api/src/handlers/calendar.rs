...
pub async fn get(state: web::Data<AppState>, path: web::Path<(i64, i64)>) -> Result<HttpResponse, AppError> {
...
pub async fn create(state: web::Data<AppState>, path: web::Path<i64>, body: web::Json<CreateCalendarRequest>) -> Result<HttpResponse, AppError> {
    body.validate()?;
    ...
    Ok(HttpResponse::Created().insert_header(("Location", location)).json(entries))
}
...
pub async fn update_price(state: web::Data<AppState>, path: web::Path<i64>, body: web::Json<UpdateCalendarPriceRequest>) -> Result<HttpResponse, AppError> {
    body.validate()?;
    let house_id = path.into_inner();
...
pub async fn delete(state: web::Data<AppState>, path: web::Path<i64>, query: web::Query<CalendarDeleteQuery>) -> Result<HttpResponse, AppError> {
