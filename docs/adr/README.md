...
|------|----------|--------|
| 2026-05-06 | [Country codes use ISO 3166-1 alpha-2](2026-05-06-country-codes-iso-3166-1-alpha-2.md) | Accepted |
| 2026-05-09 | [Input validation runs at the handler boundary, not in services](2026-05-09-validation-at-handler-boundary.md) | Accepted |
