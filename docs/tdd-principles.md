...
- The test must fail for the right reason — a missing function, wrong return value, or unhandled case. Not a compilation error in unrelated code.
- The test must follow the conventions in [`testing-principles.md`](testing-principles.md): four-phase structure, three-tier data naming, factory functions, derived expectations.
